...
- i want to start a new project. we'll need a product owner, a backend dev, a frontend dev and a qa. I'll probably talk only to the product owner to help identifying what i need. then the dev and frontend can develop it and the qa can attest to the quality
